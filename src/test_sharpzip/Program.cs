...
namespace test_sharpzip {


    class Program {
        static string zip_friendly_path_name(string name) {
            string prefix = "x:\\";
        ...
        static void dump_file_names_in_zip(string file_name) {
        ...
        static bool create_zip(string file_name, Dictionary<string, string> files) {
        ...
        static void Main(string[] args) {
            dump_file_names_in_zip(@"C:\john\code\buff\lw-result\test.logwizard");
            dump_file_names_in_zip(@"D:\downloads\win64_153330.zip");
            dump_file_names_in_zip(@"D:\downloads\vallecoccia.marco@gmail.com.zip");
            try_extract_file_names_in_zip(@"D:\downloads\vallecoccia.marco@gmail.com.zip", @"C:\john\code\buff\lw-test", new Dictionary<string, string>() {
                {"keys_user.txt", "keys.txt"},
                {"TableNinja2.log.1", "second.log"}
            });

            create_zip(@"C:\john\code\buff\lw-result\test.logwizard", new Dictionary<string, string>() {
                { @"C:\john\code\buff\lw-test\keys.txt", "k.txt" },
                { @"C:\john\code\buff\lw-test\second.log", "s.log" }
            });
        }
    }
}
